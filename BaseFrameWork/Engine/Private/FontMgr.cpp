...
HRESULT CFontMgr::AddFont(const wstring& _strFontTag, const wstring& _strFontFilePath)
{
...
HRESULT CFontMgr::Render(const wstring& _strFontTag, const wstring& _strText, const _float2& _vPosition, _fvector _vColor, _float _fRotation, const _float2& _vOrigin, _float _fScale)
{
...
shared_ptr<class CCustomFont> CFontMgr::FindFont(const wstring& _strFontTag)
{
