...
void CPlayer::MouseInput(_float _fTimeDelta)
{
    ...
    if (CGameInstance::GetInstance()->GetDIMouseState(MOUSEKEYSTATE::DIM_LB)) {
        ...
        if (m_bJump) {
            ...
            {
            case Tool::CPlayer::HEROSTATE::STATE_COMBO_ATTACK1:
                m_fMinComboAnimTime = 0.3f;
                m_NextAnimIndex.push_back({ 1 , false });
                m_bReserveCombo = true;
                break;
            case Tool::CPlayer::HEROSTATE::STATE_COMBO_ATTACK2:
                m_fMinComboAnimTime = 0.3f;
                m_NextAnimIndex.push_back({ 2 , false });
                m_fJumpSpeed = 10.f;
                m_bReserveCombo = true;
                break;
            case Tool::CPlayer::HEROSTATE::STATE_COMBO_ATTACK3:
                m_bReserveCombo = true;
                break;
            default:
                if (m_bComboAttackStart)
        ...
        //Ground Attack
            ...
            case Tool::CPlayer::HEROSTATE::STATE_COMBO_ATTACK3:
                ...
                break;
            case Tool::CPlayer::HEROSTATE::STATE_COMBO_ATTACK4:
                ...
                break;
            case Tool::CPlayer::HEROSTATE::STATE_COMBO_ATTACK5:
                m_bReserveCombo = true;
                break;
            default:
                if (m_bComboAttackStart)
